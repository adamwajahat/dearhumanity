   ...
   <div className='sourceList'>
        ...
        <div className='bio'>
            ...
            <div className='links'>
                ...
                <br></br>
                <a href='https://youtu.be/G0k3wYySFuA?t=48'>Speaks on Israel's strategy towards Palestinians from his book "Method and Madness: The Hidden Story of Israel's Assaults on Gaza" (2015)</a>
                <br></br>
        ...
        <br></br>
        <div className='bio'>
            <img src={abbyPic} className='bioImg' alt='abby'></img>
            <div className='bioDesc'>
        ...
        <br></br>
        <div className='bio'>
            <img src={ilanPic} className='bioImg' alt='ilan'></img>
            <div className='bioDesc'>
        ...
        <br></br>
        <div className='bio'>
            <img src={jimmyPic} className='bioImg' alt='jimmy'></img>
            <div className='bioDesc'>
        ...
        <br></br>
        <div className='bio'>
            <img src={mikoPic} className='bioImg' alt='miko'></img>
            <div className='bioDesc'>
        ...
        <br></br>
        <div className='bio'>
            <img src={noamPic} className='bioImg' alt='noam'></img>
            <div className='bioDesc'>
